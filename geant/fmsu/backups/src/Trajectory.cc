...
:G4VTrajectory()
{ 
  //  G4cout << "Construct Trajectory()"<< G4endl;   
...
:G4VTrajectory()
{
  //  G4cout << "Construct Trajectory(atrack)"<< G4endl;   
  fpParticleDefinition = aTrack->GetDefinition();
  ParticleName = fpParticleDefinition->GetParticleName();
  mass = (double) fpParticleDefinition->GetPDGMass();
  energy = (double) aTrack->GetTotalEnergy();
...
:G4VTrajectory()
{
  //  G4cout << "Construct Trajectory(right)"<< G4endl;   
...
void Trajectory::DrawTrajectory(G4int) const
{
