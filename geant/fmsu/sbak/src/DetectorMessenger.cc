...
:myDetector(myDet)
{ 
  N02Dir = new G4UIdirectory("/sim/");
  N02Dir->SetGuidance("UI commands specific to this example.");
  
  detDir = new G4UIdirectory("/sim/det/");
  detDir->SetGuidance("detector control.");
  
  TargMatCmd = new G4UIcmdWithAString("/sim/det/setTargetMate",this);
  ...
  ChamMatCmd = new G4UIcmdWithAString("/sim/det/setCellMate",this);
  ...
  FieldCmd = new G4UIcmdWithADoubleAndUnit("/sim/det/setField",this);  
  ...
  StepMaxCmd = new G4UIcmdWithADoubleAndUnit("/sim/det/stepMax",this);  
...
{ 
  ...
  if( command == ChamMatCmd )
   { myDetector->setCellMaterial(newValue);}  
