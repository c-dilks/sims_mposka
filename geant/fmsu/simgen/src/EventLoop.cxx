...
EventLoop::EventLoop(Int_t nEvents, Float_t sqrts)
{
  ...
  ////////////Limits
  //Generation
  etamingen=2.6; //Default 2.5
  etamaxgen=3.8;//Note these are technicaly rapdity not psudeorapdity. Negative means infinite //Default 4.4
...
//	  outstring=Form("/home/branden/testing/fmsu/macros/macro%d.mac",evt_num);
	...
	if(KF==111 && KS<10 && pt>ptmincuts && pt<ptmaxcuts && E>Emincuts && E<Emaxcuts)
	{
      ...
      {
	//Minimum bias cuts
//	if(KF==111 && KS<10 && pt>ptmincuts && pt<ptmaxcuts && E>Emincuts && E<Emaxcuts) keep=1;
	keep=1;
      }
    }
